...
Stage 1: Problem Definition & Literature Review1.1 Problem StatementThe goal is to build a classical machine learning pipeline (no deep learning) that can identify Indian coin denominations — ₹1, ₹2, ₹5, ₹10, and ₹20 — from photographs. The system must work reliably across:
